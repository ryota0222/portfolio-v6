  ...
  return (
    <div className="flex flex-col gap-2 items-center">
      <span aria-hidden role="presentation">
        {index === 1 && <Image alt="1" as={NextImage} height={23} src="/images/section/01.svg" width={27} />}
        {index === 2 && (
          <Image alt="2" as={NextImage} height={23} loading="lazy" src="/images/section/02.svg" width={27} />
        )}
      </span>
